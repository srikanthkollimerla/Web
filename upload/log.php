...
<div class="col-md-1 bg-dark1" style="padding:0px">
                   ...
                   <a href="log.php" style="position:fixed;left:0px;top:145px;min-width:8.33333%;"> <button class="btn bg-light btnp0"style="width:100%;height:100px; border-radius:0rem;border-left:4px solid tomato;"><i class="fa fa-2x fa-list"></i><br class="h6" style="margin-bottom:0rem;">BOM </br></button></a>
